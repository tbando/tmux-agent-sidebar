...
pub use options::{
    BG_CMD_PLACEHOLDER, PANE_AGENT, PANE_ATTENTION, PANE_BG_CMD, PANE_CWD, PANE_EFFORT, PANE_MODEL,
    ...
    SIDEBAR_COLOR_ACTIVITY_TIMESTAMP, SIDEBAR_COLOR_AGENT_ANTIGRAVITY, SIDEBAR_COLOR_AGENT_CLAUDE,
    SIDEBAR_COLOR_AGENT_CODEX, SIDEBAR_COLOR_AGENT_OPENCODE, SIDEBAR_COLOR_ALL,
    ...
    SIDEBAR_COLOR_RESPONSE_ARROW, SIDEBAR_COLOR_RUNNING, SIDEBAR_COLOR_RUNNING_SPINNER,
    ...
    SIDEBAR_ICON_BACKGROUND, SIDEBAR_ICON_ERROR, SIDEBAR_ICON_GIT_AHEAD, SIDEBAR_ICON_GIT_BEHIND,
    SIDEBAR_ICON_GIT_DIVERGED, SIDEBAR_ICON_GIT_SYNCED, SIDEBAR_ICON_IDLE, SIDEBAR_ICON_RUNNING,
...
pub use types::{
    ANTIGRAVITY_AGENT, AgentType, CLAUDE_AGENT, CODEX_AGENT, OPENCODE_AGENT, PaneInfo, PaneStatus,
